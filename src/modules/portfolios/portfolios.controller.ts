...
export class PortfoliosController {
  ...
  @Get()
  @ApiOperation({
    summary: "List all portfolios the current user is a member of",
  })
  ...
  @HttpCode(HttpStatus.CREATED)
  @ApiOperation({
    summary: "Invite a member to the portfolio by email (OWNER only)",
  })
  @ApiParam({ name: "id", description: "Portfolio UUID" })
  addMemberByEmail(
    @Request() req: any,
  ...
  updateMemberRole(
    ...
    return this.portfoliosService.updateMemberRole(
      id,
      req.user.id,
      targetUserId,
      dto,
